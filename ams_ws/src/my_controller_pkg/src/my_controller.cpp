...
class MyController : public controller_interface::Controller<hardware_interface::EffortJointInterface>
{
	public:
	  ...
	  /*
			Helper function to set the internal command structure
	  */
	  ...
	  */
	  ...
	  /*
			...
			- get the joint name from parameter server
			- initialize the PID controller of the joint
	  ...
	  */
	  ...
	  /*
			Called by the controller_manager to update the controller
			- calculates an error rate
			- sets the PID controller of the joint to new values
	  */
	  ...
	  /*
			Called from controller_manager to start the controller
			- sets actual position as commanded position
			- resets the PID controller of the joint
	  */
	  ...
	  /*
			called from controller_manager to stop this controller
	  */
	  void stopping(const ros::Time& /*time*/) override
	  {}

	  /*
			This callback is called whenever a message is sent to /command node
	  */
