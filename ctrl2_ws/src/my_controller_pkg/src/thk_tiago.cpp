...
int main (int argc, char** argv) {
	...
	//ros::Publisher thk_torso_pub = n.advertise<std_msgs::Float64>("/thk_ns/thk_torso_controller/command",100);
	...
	//ros::Publisher thk_gl_pub = n.advertise<std_msgs::Float64>("/thk_ns/thk_gl_controller/command",10);
	//ros::Publisher thk_gr_pub = n.advertise<std_msgs::Float64>("/thk_ns/thk_gr_controller/command",10);
	...
	//grip.points[1].positions.resize(1);
	//grip.points[1].time_from_start = ros::Duration(1);
